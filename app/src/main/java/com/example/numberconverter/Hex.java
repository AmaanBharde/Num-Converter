    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b_convert.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                tvb_output.setText("HEXADECIMAL FORM: " + input + "\n" +
    ...
    public void  b_save(){
        b_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isInserted =true)
                    Toast.makeText(Hex.this,"Data Inserted",Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(Hex.this,"Data not Inserted",Toast.LENGTH_LONG).show();
            }
        });
    }
    public void b_view() {
