    ...
    public void  b_save(){
        b_save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(isInserted =true)
                    Toast.makeText(Oct.this,"Data Inserted",Toast.LENGTH_LONG).show();
                else
                    Toast.makeText(Oct.this,"Data not Inserted",Toast.LENGTH_LONG).show();
            }
        });
    }
    public void b_view() {
